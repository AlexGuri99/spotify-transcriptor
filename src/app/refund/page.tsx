      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-8 py-16">
        ...
        <div className="font-[family-name:var(--font-barlow-condensed)] text-sm text-gray-600 space-y-6 leading-relaxed">
          ...
          <section>
            ...
            <p>
              If you experience a technical issue that prevents you from using the Service (e.g., a transcription fails and credits are deducted without receiving a result), please contact us at support@tranzkript.com within 7 days of the incident. We will review the issue and may, at our discretion, restore the credits or issue a refund.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To request a refund, contact us at support@tranzkript.com with your account email and a description of the issue. We aim to respond within 5 business days.
            </p>
          </section>
