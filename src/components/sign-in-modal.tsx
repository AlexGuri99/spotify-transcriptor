      ...
      <div className="mx-4 w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-8 shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="font-sans flex w-full items-center justify-center gap-3 rounded-xl bg-black px-4 py-3 text-sm font-medium text-white hover:bg-gray-900 transition-all cursor-pointer"
          >
